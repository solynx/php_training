...
<section class="section pb-0 mt-4">
                    ...
                    <div class="row justify-content-end">
                        <div class="col-xxl-4">
                            <div class="text-end py-4 px-5 mx-xxl-5">
                                ...
                                <div>
                                    <a href="#!" class="link-effect link-light">Show Collections <i class="ri-arrow-right-line align-bottom ms-1"></i></a>
                                </div>
                            </div>
                        </div><!--end col-->
                    </div><!--end row-->
                    ...
                    <div class="offer-bar flex-shrink-0">
                        <div class="d-flex gap-3 flex-column">
                            <div class="card fs-13 border border-primary border-opacity-25">
                                ...
                                <div class="card-body">
                                    <div class="px-5">
                                        <img src="../assets/images/products/img-16.png" alt="" class="img-fluid d-block mx-auto">
                                    </div>
                                    <div class="mt-4 text-center">
                                        <h4 class="text-dark mb-3">$63.00 <span class="text-muted fs-12"><del>$123.99</del></span></h4>
                ...
                <div class="row">
                        ...
                        <div class="ecommerce-deals-widgets">
                            <div class="card overflow-hidden mb-0">
                                <div class="gallery-product">
                                    <img src="../assets/images/ecommerce/img-5.jpg" alt="" class="mx-auto d-block object-fit-cover">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="ecommerce-deals-widgets">
                            <div class="card overflow-hidden mb-0">
                                <div class="gallery-product">
                                    <img src="../assets/images/ecommerce/img-3.jpg" alt="" class="mx-auto d-block object-fit-cover">
                                </div>
                            </div>
                            <div class="content mx-4">
                                <div class="countdown-deals mb-3">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="ecommerce-deals-widgets">
                            <div class="card overflow-hidden mb-0">
                                <div class="gallery-product">
                                    <img src="../assets/images/ecommerce/img-1.jpg" alt="" class="mx-auto d-block object-fit-cover">
                                </div>
                            </div>
                            <div class="content mx-4">
                                <div class="countdown-deals mb-3">
        ...
        <section class="section footer-landing pb-0">
            <div class="container">
                ...
                <div class="row footer-border-alt mt-4 align-items-center fs-15">
                    <div class="col-sm-6">
                        <script>document.write(new Date().getFullYear())</script> © Toner. Design &amp; Develop by <a href="#!" class="text-reset text-decoration-underline">Themesbrand</a>
                    </div>
                    <div class="col-sm-6">
        ...
        <script src="../assets/js/frontend/product-grid.init.js"></script>
