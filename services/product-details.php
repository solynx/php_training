            ...
            <div class="container">
                <div class="row gx-2">
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-md-2">
                                <div thumbsslider="" class="swiper productSwiper mb-3 mb-lg-0 swiper-initialized swiper-vertical swiper-pointer-events swiper-free-mode swiper-watch-progress swiper-backface-hidden swiper-thumbs">
                                    <div class="swiper-wrapper" id="swiper-wrapper-b856c73bbefe649e" aria-live="polite" style="transform: translate3d(0px, 0px, 0px); transition-duration: 0ms;">
                                        <div class="swiper-slide swiper-slide-visible swiper-slide-active swiper-slide-thumb-active" role="group" aria-label="1 / 5" style="height: 105px; margin-bottom: 10px;">
                                            <div class="product-thumb rounded cursor-pointer">
                                                <img src="../assets/images/products/img-31.png" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="swiper-slide swiper-slide-visible swiper-slide-next" role="group" aria-label="2 / 5" style="height: 105px; margin-bottom: 10px;">
                                            <div class="product-thumb rounded cursor-pointer">
                                                <img src="../assets/images/products/img-33.png" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="swiper-slide swiper-slide-visible" role="group" aria-label="3 / 5" style="height: 105px; margin-bottom: 10px;">
                                            <div class="product-thumb rounded cursor-pointer">
                                                <img src="../assets/images/products/img-32.png" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="swiper-slide swiper-slide-visible" role="group" aria-label="4 / 5" style="height: 105px; margin-bottom: 10px;">
                                            <div class="product-thumb rounded cursor-pointer">
                                                <img src="../assets/images/products/img-34.png" alt="" class="img-fluid">
                                            </div>
                                        </div>
                                        <div class="swiper-slide swiper-slide-visible" role="group" aria-label="5 / 5" style="height: 105px; margin-bottom: 10px;">
                                            <div class="product-thumb rounded cursor-pointer">
                            ...
                            <div class="col-md-10">
                                <div class="bg-light rounded-2 position-relative ribbon-box overflow-hidden">
                                    ...
                                    <div class="swiper productSwiper2 swiper-initialized swiper-horizontal swiper-pointer-events swiper-backface-hidden">
                                        <div class="swiper-wrapper" id="swiper-wrapper-e7ec32369095fecc" aria-live="polite" style="transform: translate3d(-468px, 0px, 0px); transition-duration: 0ms;"><div class="swiper-slide swiper-slide-duplicate swiper-slide-prev" data-swiper-slide-index="4" role="group" aria-label="5 / 5" style="width: 458px; margin-right: 10px;">
                                                <img src="../assets/images/products/img-34.png" alt="" class="img-fluid">
                                            </div>
                                            <div class="swiper-slide swiper-slide-active" data-swiper-slide-index="0" role="group" aria-label="1 / 5" style="width: 458px; margin-right: 10px;">
                                                <img src="../assets/images/products/img-31.png" alt="" class="img-fluid">
                                            </div>
                                            <div class="swiper-slide swiper-slide-next" data-swiper-slide-index="1" role="group" aria-label="2 / 5" style="width: 458px; margin-right: 10px;">
                                                <img src="../assets/images/products/img-33.png" alt="" class="img-fluid">
                                            </div>
                                            <div class="swiper-slide" data-swiper-slide-index="2" role="group" aria-label="3 / 5" style="width: 458px; margin-right: 10px;">
                                                <img src="../assets/images/products/img-32.png" alt="" class="img-fluid">
                                            </div>
                                            <div class="swiper-slide" data-swiper-slide-index="3" role="group" aria-label="4 / 5" style="width: 458px; margin-right: 10px;">
                                                <img src="../assets/images/products/img-34.png" alt="" class="img-fluid">
                                            </div>
                                            <div class="swiper-slide swiper-slide-duplicate-prev" data-swiper-slide-index="4" role="group" aria-label="5 / 5" style="width: 458px; margin-right: 10px;">
                                                <img src="../assets/images/products/img-34.png" alt="" class="img-fluid">
                                            </div>
                                        <div class="swiper-slide swiper-slide-duplicate swiper-slide-duplicate-active" data-swiper-slide-index="0" role="group" aria-label="1 / 5" style="width: 458px; margin-right: 10px;">
                                                <img src="../assets/images/products/img-31.png" alt="" class="img-fluid">
                                            </div></div>
                                        <div class="swiper-button-next bg-transparent" tabindex="0" role="button" aria-label="Next slide" aria-controls="swiper-wrapper-e7ec32369095fecc"></div>
                                        <div class="swiper-button-prev bg-transparent" tabindex="0" role="button" aria-label="Previous slide" aria-controls="swiper-wrapper-e7ec32369095fecc"></div>
                                    <span class="swiper-notification" aria-live="assertive" aria-atomic="true"></span></div>
                                </div>
                            </div><!--end col-->
                            <div class="col-lg-12">
                        ...
                        <div class="tab-content text-muted">
                            ...
                            <div class="tab-pane" id="profile1" role="tabpanel">
                                ...
                                <div>
                                    ...
                                    <div class="mt-4" data-simplebar="init" style="max-height: 350px"><div class="simplebar-wrapper" style="margin: 0px;"><div class="simplebar-height-auto-observer-wrapper"><div class="simplebar-height-auto-observer"></div></div><div class="simplebar-mask"><div class="simplebar-offset" style="right: 0px; bottom: 0px;"><div class="simplebar-content-wrapper" tabindex="0" role="region" aria-label="scrollable content" style="height: auto; overflow: hidden;"><div class="simplebar-content" style="padding: 0px;">
        ...
        <section class="section footer-landing pb-0">
            <div class="container">
                ...
                <div class="row footer-border-alt mt-4 align-items-center fs-15">
                    <div class="col-sm-6">
                        <script>document.write(new Date().getFullYear())</script>2023 © Toner. Design &amp; Develop by <a href="#!" class="text-reset text-decoration-underline">Themesbrand</a>
                    </div>
                    <div class="col-sm-6">
