                                                ...
                                                <div class="d-flex align-items-center gap-2">
                                                    <div class="avatar-sm flex-shrink-0">
                                                        <div class="avatar-title bg-dark-subtle rounded-3">
                                                            <img src="../assets/images/products/img-16.png" alt="" class="avatar-xs">
                                                        </div>
                                                    </div>
                                                    <div class="flex-grow-1">
                    ...
                    <div class="mt-4 pt-2">
                        <div class="d-flex align-items-center mb-4">
                            ...
                            <div class="flex-shrink-0">
                                <a href="address.html" class="badge badge-soft-secondary link-secondary">
                                    Add Address
                                </a>
                            </div>
                        </div>
                        <div class="row gy-3">
                            <div class="col-lg-6 col-12">
                                ...
                                <div class="d-flex flex-wrap p-2 py-1 bg-light rounded-bottom border mt-n1">
                                    <div>
                                        <a href="address.html" class="d-block text-body p-1 px-2"><i class="ri-pencil-fill text-muted align-bottom me-1"></i> Edit</a>
                                    </div>
                                    <div>
                ...
                <div class="col-lg-4">
                    <div class="sticky-side-div">
                        ...
                        <div class="hstack gap-2 justify-content-between justify-content-end">
                            ...
                            <a href="payment.html" class="btn btn-hover btn-primary w-100">Continue Payment</a>
                        </div>
