                        ...
                        <div class="dropdown topbar-head-dropdown topbar-tag-dropdown justify-content-end">
                            ...
                            <div class="dropdown-menu dropdown-menu-end">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item language" data-lang="sa"
                                    title="Arabic">
                                    <img src="../assets/images/flags/sa.svg" alt="user-image"
                                        class="me-2 rounded-circle" height="18">
    ...
    <nav class="navbar navbar-expand-lg ecommerce-navbar" id="navbar">
        <div class="container">
            <a class="navbar-brand d-none d-lg-block" href="index.html">
                <div class="logo-dark">
                    <img src="../assets/images/sim-logo.png" alt="" height="42">
                </div>
                ...
                <ul class="navbar-nav mx-lg-auto mb-2 mb-lg-0" id="navigation-menu">
                    <li class="nav-item d-block d-lg-none">
                        <a class="d-block p-3 h-auto text-center" href="index.html">
                            <img src="../assets/images/sim-logo.png" alt="" height="25">
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="index.html" data-key="t-home">Trang chủ</a>
                    </li>
                            ...
                            <div class="row g-0 g-lg-4">
                                <div class="col-lg-2 d-none d-lg-block">
                                    <div class="card rounded-start rounded-0 border-0 h-100 mb-0 overflow-hidden"
                                        style="background-image: url('../assets/images/ecommerce/img-1.jpg');background-size: cover;">
                                        <div class="bg-overlay bg-light bg-opacity-25"></div>
                                        <div class="card-body d-flex align-items-center justify-content-center">
                                            <div class="text-center">
                                                <a href="#!" class="btn btn-secondary btn-hover"><i
                                    ...
                                    <ul class="dropdown-menu-list list-unstyled mb-0 py-3">
                                        <li>
                                            <p class="mb-2 text-uppercase fs-11 fw-medium text-muted menu-title"
                                                data-key="t-men">SIM Châu Á</p>
                                        </li>
                                        <li class="nav-item">
                                            <a href="/services/clothing.php" class="nav-link" data-key="t-clothing">SIM
                                                Du Lịch Trung Quốc</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="product-grid-right.html" class="nav-link" data-key="t-watches">SIM
                                                Du Lịch Đài Loan</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="product-list-left.html" class="nav-link"
                                                data-key="t-bags-Luggage">SIM Du Lịch Hàn Quốc</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="product-grid-right.html" class="nav-link" data-key="t-footwear">SIM
                                                Du Lịch Nhật Bản</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="product-list.html" class="nav-link" data-key="t-innerwear">SIM Du
                                                Lịch Thái Lan</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="product-list-right.html" class="nav-link"
                                                data-key="t-other-accessories">SIM Các Nước Khác</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-lg-2">
                                    <ul class="dropdown-menu-list list-unstyled mb-0 py-3">
                                        <li>
                                            <p class="mb-2 text-uppercase fs-11 fw-medium text-muted menu-title"
                                                data-key="t-women">SIM Châu Âu & Mỹ</p>
                                        </li>
                                        <li class="nav-item">
                                            <a href="product-list-defualt.html" class="nav-link"
                                                data-key="t-western-wear">SIM Nhiều Nước Châu Âu</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="product-list-left.html" class="nav-link"
                                                data-key="t-handbags-clutches">SIM Du Lịch Nga</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="product-grid-right.html" class="nav-link"
                                                data-key="t-lingerie-nightwear">SIM Du Lịch Mỹ</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="product-grid-sidebar-banner.html" class="nav-link"
                                                data-key="t-footwear">Một Số Nước Âu & Mỹ Khác</a>
                                        </li>
                                ...
                                <div class="col-lg-2">
                                    <ul class="dropdown-menu-list list-unstyled mb-0 py-3">
                                        <li>
                                            <p class="mb-2 text-uppercase fs-11 fw-medium text-muted menu-title"
                                                data-key="t-accessories-others">SIM Châu Úc & Phi</p>
                                        </li>
                                        <li class="nav-item">
                                            <a href="product-grid-right.html" class="nav-link"
                                                data-key="t-home-kitchen-pets">SIM Du Lịch Australia</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="product-list-left.html" class="nav-link"
                                                data-key="t-beauty-health-grocery">SIM Du Lịch New Zealand</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="product-grid-sidebar-banner.html" class="nav-link"
                                                data-key="t-sports-fitness-bags-luggage">SIM Du Lịch Dubai | UAE</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="product-list.html" class="nav-link"
                                                data-key="t-car-motorbike-industrial">SIM Du Lịch Qatar</a>
                                        </li>
                                ...
                                <div class="col-lg-2">
                                    <ul class="dropdown-menu-list list-unstyled mb-0 py-3">
                                        <li>
                                            <p class="mb-2 text-uppercase fs-11 fw-medium text-muted menu-title"
                                                data-key="t-others">Khác</p>
                                        </li>
                                        <li class="nav-item">
                                            <a href="auth-signup-basic.html" class="nav-link" data-key="t-sign-up">SIM
                                                Quốc Tế</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="auth-signin-basic.html" class="nav-link" data-key="t-sign-in">E-SIM
                                                Du Lịch</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="auth-pass-reset-basic.html" class="nav-link"
                                                data-key="t-sign-in">Đăng Nhập</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="auth-404-cover.html" class="nav-link" data-key="t-sign-up">Đăng
                                                Ký</a>
                                        </li>
                                    </ul>
                                </div>
                                <div class="col-lg-2 d-none d-lg-block">
                                    <div class="p-3">
                                        <p class="mb-3 text-uppercase fs-11 fw-medium text-muted"
                                            data-key="t-top-brands">Top Brands</p>
                                        <div class="row g-2">
                                            <div class="col-lg-4">
                                                <a href="#!"
                                                    class="d-block p-2 border border-dashed text-center rounded-3">
                                                    <img src="../assets/images/brands/img-8.png" alt=""
                                                        class="avatar-sm">
                                                </a>
                                            </div>
                                            <div class="col-lg-4">
                        ...
                        <div class="dropdown-menu dropdown-mega-menu-xl dropdown-menu-center p-0">
                            <div class="row g-0 g-lg-4">
                                <div class="col-lg-5 d-none d-lg-block">
                                    <div class="card rounded-start rounded-0 border-0 h-100 mb-0 overflow-hidden"
                                        style="background-image: url('../assets/images/ecommerce/img-2.jpg'); background-size: cover;">
                                    ...
                                    <div class="row g-0 g-lg-4">
                                        <div class="col-lg-6">
                                            <div class="py-3">
                                                <ul class="dropdown-menu-list list-unstyled mb-0">
                                                    <li>
                                                        <p class="mb-2 text-uppercase fs-11 fw-medium text-muted menu-title"
                                                            data-key="t-checkout-pages">Checkout Pages</p>
                                                    </li>
                                                    <li class="nav-item">
                                        ...
                                        <div class="col-lg-6">
                                            <ul class="dropdown-menu-list list-unstyled mb-0 py-3">
                                                ...
                                                <li class="nav-item">
                                                    <a href="/services/checkout.php" class="nav-link"
                        ...
                        <ul class="dropdown-menu dropdown-menu-md dropdown-menu-center dropdown-menu-list submenu">
                            <li class="nav-item dropdown dropdown-hover">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                    aria-expanded="false" data-key="t-products">Products</a>
                                <ul class="dropdown-menu submenu">
                                    <li class="dropdown dropdown-hover">
                                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                            aria-expanded="false" data-key="t-grid-view">Grid View</a>
                                        <ul class="dropdown-menu submenu">
                                            <li><a class="nav-link" href="product-grid-defualt.html"
                                                    data-key="t-defualt">Defualt</a></li>
                                            <li><a class="nav-link" href="product-grid-sidebar-banner.html"
                                                    data-key="t-sidebar-with-banner">Sidebar with Banner</a></li>
                                            <li><a class="nav-link" href="product-grid-right.html"
                                                    data-key="t-right-sidebar">Right Sidebar</a></li>
                                            <li><a class="nav-link" href="product-grid.html" data-key="t-no-sidebar">No
                                                    Sidebar</a></li>
                                        </ul>
                                    </li>
                                    <li class="dropdown dropdown-hover">
                                        ...
                                        <ul class="dropdown-menu submenu">
                                            <li><a class="nav-link" href="product-list-defualt.html"
                                                    data-key="t-defualt">Defualt</a></li>
                                            <li><a class="nav-link" href="product-list-left.html"
                                                    data-key="t-left-sidebar">Left Sidebar</a></li>
                                            <li><a class="nav-link" href="product-list-right.html"
                                                    data-key="t-right-sidebar">Right Sidebar</a></li>
                                            <li><a class="nav-link" href="product-list.html" data-key="t-no-sidebar">No
                                                    Sidebar</a></li>
                                        </ul>
                                    </li>
                                    <li><a class="nav-link" href="/services/product-details.php"
                                            data-key="t-product-details">Product Details</a></li>
                                </ul>
                            </li>
                            <li class="nav-item dropdown dropdown-hover">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                    aria-expanded="false" data-key="t-users">Users</a>
                                <ul class="dropdown-menu submenu">
                                    <li><a class="nav-link" href="account.html" data-key="t-my-account">My Account</a>
                                    </li>
                                    <li><a class="nav-link" href="auth-signin-basic.html" data-key="t-sign-in">Sign
                                            In</a></li>
                                    <li><a class="nav-link" href="auth-signup-basic.html" data-key="t-sign-up">Sign
                                            Up</a></li>
                                    <li><a class="nav-link" href="auth-pass-reset-basic.html"
                                            data-key="t-passowrd-reset">Password Reset</a></li>
                                    <li><a class="nav-link" href="auth-pass-change-basic.html"
                                            data-key="t-create-password">Password Create</a></li>
                                    <li><a class="nav-link" href="auth-success-msg-basic.html"
                                            data-key="t-success-message">Success Message</a></li>
                                    <li><a class="nav-link" href="auth-twostep-basic.html"
                                            data-key="t-two-step-verify">Two Step Verify</a></li>
                                    <li><a class="nav-link" href="auth-logout-basic.html" data-key="t-logout">Logout</a>
                                    </li>
                                    <li><a class="nav-link" href="auth-404.html" data-key="t-error-404">Error 404</a>
                                    </li>
                                    <li><a class="nav-link" href="auth-500.html" data-key="t-error-500">Error 500</a>
                                    </li>
                                    <li><a class="nav-link" href="coming-soon.html" data-key="t-coming-soon">Coming
                                            Soon</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                <a href="/services/products-category.php" class="nav-link"
                            ...
                            <li class="nav-item dropdown dropdown-hover">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                    aria-expanded="false" data-key="t-email-template">Email Template</a>
                                <ul class="dropdown-menu submenu">
                                    <li><a class="nav-link" href="email-black-friday.html"
                                            data-key="t-black-friday">Black Friday</a></li>
                                    <li><a class="nav-link" href="email-flash-sale.html" data-key="t-flash-sale">Flash
                                            Sale</a></li>
                                    <li><a class="nav-link" href="email-order-success.html"
                                            data-key="t-order-success">Order Success</a></li>
                                    <li><a class="nav-link" href="email-order-success-2.html"
                                            data-key="t-order-success-2">Order Success 2</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                <a href="../components/index.html" class="nav-link" target="_blank"
                                    data-key="t-components">Components <span
                                        class="badge bg-danger align-bottom ms-1">1.0</span></a>
                            </li>
                            <li class="nav-item dropdown dropdown-hover">
                                <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown"
                                    aria-expanded="false" data-key="t-multi-level">Multi Level</a>
                                <ul class="dropdown-menu submenu">
                                    ...
                                    <li class="dropdown dropdown-hover">
                                        ...
                                        <ul class="dropdown-menu submenu">
                                            ...
                                            <li class="dropdown dropdown-hover">
                                                ...
                                                <ul class="dropdown-menu submenu">
                                                    <li><a class="nav-link" href="#" data-key="t-level-3.1">Level
                                                            3.1</a></li>
                                                    <li><a class="nav-link" href="#" data-key="t-level-3.2">Level
                                                            3.2</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="contact-us.html" data-key="t-contact">Liên Hệ</a>
                    </li>
                </ul>
            </div>
                ...
                <div class="dropdown header-item dropdown-hover-end">
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a class="dropdown-item" href="order-history.html"><i
                                ...
                                class="align-middle">Order History</span></a>
                        ...
                        <div class="d-flex gap-3">
                            ...
                            <div class="flex-grow-1">
                                ...
                                <div class="d-flex mb-3 gap-2">
                                    <div class="text-muted fw-medium mb-0">$<span class="product-price">24.00</span>
                                    </div>
                                    <div class="vr"></div>
            ...
            <div class="modal-content border-0">
                <div class="modal-body p-0 bg-info-subtle rounded">
                    <div class="row g-0 align-items-center">
                        <div class="col-lg-6">
                            <div class="p-4 h-100">
                                <span class="badge badge-soft-info fs-13">GET 10% SALE OFF</span>
