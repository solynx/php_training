                                ...
                                <div class="row g-0 g-lg-4">
                                    ...
                                    <div class="col-lg-2">
                                        <ul class="dropdown-menu-list list-unstyled mb-0 py-3">
                                            ...
                                            <li class="nav-item">
                                                <a href="/services/clothing.php" class="nav-link" data-key="t-clothing">Clothing</a>
                                            </li>
                                            <li class="nav-item">
                                        ...
                                        <div class="row g-0 g-lg-4">
                                            ...
                                            <div class="col-lg-6">
                                                <ul class="dropdown-menu-list list-unstyled mb-0 py-3">
                                                    ...
                                                    <li class="nav-item">
                                                        <a href="/services/checkout.php" class="nav-link" data-key="t-checkout">Checkout</a>
                                                    </li>
                                                    <li class="nav-item">
                            ...
                            <ul class="dropdown-menu dropdown-menu-md dropdown-menu-center dropdown-menu-list submenu">
                                <li class="nav-item dropdown dropdown-hover">
                                    ...
                                    <ul class="dropdown-menu submenu">
                                        ...
                                        <li><a class="nav-link" href="/services/product-details.php" data-key="t-product-details">Product Details</a></li>
                                    </ul>
                                </li>
                                <li class="nav-item dropdown dropdown-hover">
                                ...
                                <li class="nav-item">
                                    <a href="/services/products-category.php" class="nav-link" data-key="t-categories">Categories</a>
                                </li>
                                <li class="nav-item">
