...
function setLanguage(lang) {
    if (document.getElementById("header-lang-img")) {
        if (lang == "en") {
            ...
            document.getElementById("lang-name").innerHTML = "EspaĂ±ola"
        } else if (lang == "gr") {
