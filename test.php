...
<html lang="en" data-bs-theme="light" data-footer="dark">
    ...
    <head>
        ...
        <meta charset="utf-8">
        <title>Products Category | Toner eCommerce + Admin HTML Template</title>
    ...
    <div class="w-100">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-lg-auto mb-2 mb-lg-0" id="navigation-menu">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="index.html" data-key="t-home">Home</a>
                        </li>
                                        ...
                                        <div class="card rounded-start rounded-0 border-0 h-100 mb-0 overflow-hidden" style="background-image: url('../assets/images/ecommerce/img-1.jpg');background-size: cover;">
                                            ...
                                            <div class="card-body d-flex align-items-center justify-content-center">
                                                <div class="text-center">
                                                    <a href="#!" class="btn btn-secondary btn-hover"><i class="ph-storefront align-middle me-1"></i> <span data-key="t-shop-now">Shop Now</span></a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="swiper-wrapper py-4">
                                ...
                                <div class="swiper-slide">
                                    <div class="card card-animate overflow-hidden">
                                        ...
                                        <div class="card-body text-center">
                                            <a href="product-list.html" class="stretched-link">
                                                <h6 class="fs-16 lh-base text-truncate">Furniture & Decore</h6>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row g-2">
                            <div class="col-lg-12">
                                <div class="card mb-0">
                                    <a href="product-list-defualt.html" class="insta-img categrory-box rounded-3">
                                        <div class="categrory-content text-center">
                                            <span class="categrory-text text-white fs-18">Cosmatics</span>
                                        </div>
        ...
        <script src="../assets/js/frontend/category.init.js"></script>
